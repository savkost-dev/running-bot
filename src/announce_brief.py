...
_MODES_PROMPT = (
    ...
    "а условие стимула. Проверяй это для КАЖДОЙ группы отдельно, быстрые — не исключение: "
    "их темпы из анонса тоже могут быть невыполнимы целиком, тогда режим для них "
    "задаётся ниже темпа анонса. Прогрессию темпа внутри тренировки не придумывай — "
