...
_MODES_PROMPT = (
    ...
    '"intensity": "интенсивность относительно ПАНО/МПК (например: 90-95% от ПАНО; на уровне МПК)", '
    '"note": "1-2 предложения расшифровки: ориентир пульса, ощущения, зачем этот элемент"}]\n'
